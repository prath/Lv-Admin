            ...
            <form action="tour-preferences.html">
                <div class="columns">
                    ...
                    <div class="column generic-heading is-one-third ">
                        <button type="submit" class="btn btn--medium btn--primary is-right"> Add Tour Preferences
                        </button>
                    </div>
            ...
            <div class="columns filter-table-list">
                ...
                <div class="column is-full filter-wrapper">
                    ...
                    <div class="form-group icon-search">
                        ...
                        <input type="text" class="form-control" id="form1" placeholder="Find Tour Preferences">
                    </div>
                </div>
